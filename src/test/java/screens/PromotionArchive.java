...
public class PromotionArchive {
    ...
    SelenideElement buttonArchive= $x("//android.view.View[@resource-id=\"__nuxt\"]/android.view.View[1]/android.widget.ListView[2]/android.view.View[4]");
    SelenideElement titleArchive= $x("//android.webkit.WebView[@text=\"Архив акций\"]");
    SelenideElement titleMore= $x("//android.widget.TextView[@text=\"Узнать подробнее\"]");
