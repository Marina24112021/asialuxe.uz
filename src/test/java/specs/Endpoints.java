...
public class Endpoints {
    ...
    public static final String NEW_PASSENGER = "https://api.asialuxe.app/mobile/user-document";
    public static final String LIST_PASSENGERS = "https://api.asialuxe.app/mobile/user-document?sort=1";
    public static final String DELETE_UPDATE_PASSENGER = "https://api.asialuxe.app/mobile/user-document/";
