...
public class HotelsPage {
    ...
    final SelenideElement elementHotel = $(".content-title.my-3.h5.w-\\[50\\%\\].md\\:w-full.transition-200.dark\\:text-white-100");
    final ElementsCollection swiperWrapper = $$(".swiper-wrapper");
    final SelenideElement facilities = $("#facilities");
    final SelenideElement location = $("h3.mb-2.card-title.transition-200.dark\\:\\!text-white-100");
    final SelenideElement policy = $(".card-title.mb-3.transition-200.dark\\:\\!text-white-100");
    final SelenideElement checkInOut = $("div[data-v-152fdae9].flex.items-center.gap-2");
    final SelenideElement instruction = $("div[data-v-152fdae9].flex.items-start.gap-3.transition-200.dark\\:\\!text-white-100");
